...
class SearchAllStage(Enum):
    ...
    EXPANDING_QUERY = "Understanding and expanding query"
    SELECTING_SUBQUERIES = "Evaluating and Selecting subqueries"
    SEARCHING_WEB = "Searching the web"
    SEARCHING_LOCAL = "Searching local knowledge base"
    READING_LOCAL_KNOWLEDGE = "Reading local knowledge base"
    READING_WEBPAGES = "Reading downloaded webpages"
    READING_WEBPAGES_AND_LOCAL = "Reading downloaded webpages and local knowledge base"
    LOCAL_KNOWLEDGE = "Reading local knowledge base"
    QUERIED_WEB = "Perfroming a web search"
    DOWNLOADED_WEBPAGES = "Reading and Downloading Webpages"
...
async def download_webpages_ddg(keyword, limit=5, output_dir='tmp/downloaded_webpages'):
    """
